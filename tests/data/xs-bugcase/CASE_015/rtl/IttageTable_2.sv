...
module IttageTable_2(
  ...
  input  [8:0]  io_req_bits_foldedHist_hist_6_foldedHist,
  input  [7:0]  io_req_bits_foldedHist_hist_5_foldedHist,
  ...
  input  [8:0]  io_update_foldedHist_hist_6_foldedHist,
  input  [7:0]  io_update_foldedHist_hist_5_foldedHist,
  ...
  wire [7:0]  s0_setIdx =
    io_req_bits_startPc_addr[8:1] ^ io_req_bits_foldedHist_hist_5_foldedHist;
  ...
  wire [8:0]  updateTag =
    io_update_startPc_addr[17:9] ^ io_update_foldedHist_hist_6_foldedHist
    ^ {io_update_foldedHist_hist_5_foldedHist, 1'h0};
  ...
  wire [7:0]  ittage_write_buffer_bank1_io_write_0_bits_setIdx =
    usefulCanReset
      ? resetSet
      : io_update_startPc_addr[8:1] ^ io_update_foldedHist_hist_5_foldedHist;
  ...
  always @(posedge clock) begin
    if (_usefulCanReset_T) begin
      s1_tag <=
        io_req_bits_startPc_addr[17:9] ^ io_req_bits_foldedHist_hist_6_foldedHist
        ^ {io_req_bits_foldedHist_hist_5_foldedHist, 1'h0};
