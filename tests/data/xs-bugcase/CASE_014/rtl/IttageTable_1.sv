...
module IttageTable_1(
  ...
  input  [7:0]  io_req_bits_foldedHist_hist_2_foldedHist,
  input  [6:0]  io_req_bits_foldedHist_hist_1_foldedHist,
  ...
  input  [7:0]  io_update_foldedHist_hist_2_foldedHist,
  input  [6:0]  io_update_foldedHist_hist_1_foldedHist,
  ...
  wire [6:0]  s0_setIdx =
    io_req_bits_startPc_addr[7:1] ^ io_req_bits_foldedHist_hist_1_foldedHist;
  ...
  wire [8:0]  updateTag =
    {io_update_startPc_addr[16],
     io_update_startPc_addr[15:8] ^ io_update_foldedHist_hist_2_foldedHist}
    ^ {io_update_foldedHist_hist_2_foldedHist, 1'h0};
  ...
  wire [6:0]  ittage_write_buffer_bank1_io_write_0_bits_setIdx =
    usefulCanReset
      ? resetSet
      : io_update_startPc_addr[7:1] ^ io_update_foldedHist_hist_1_foldedHist;
    ...
    if (_usefulCanReset_T) begin
      s1_tag <=
        {io_req_bits_startPc_addr[16],
         io_req_bits_startPc_addr[15:8] ^ io_req_bits_foldedHist_hist_2_foldedHist}
        ^ {io_req_bits_foldedHist_hist_2_foldedHist, 1'h0};
