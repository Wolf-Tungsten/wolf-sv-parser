...
module MbistPipeIttage_4(
  ...
  wire [75:0] sramDataOut_1;
  wire [75:0] sramDataOut_0;
  reg  [7:0]  arrayReg;
  reg         reqReg;
  reg         allReg;
  reg         wenReg;
  ...
  reg         renReg;
  reg  [7:0]  addrRdReg;
  wire        selectedVec_0 = arrayReg == 8'hA4;
  wire        doSpread = selectedVec_0 | allReg;
  assign sramDataOut_0 = selectedVec_0 ? toSRAM_0_rdata : 76'h0;
  wire        selectedVec_0_1 = arrayReg == 8'hA5;
  wire        doSpread_1 = selectedVec_0_1 | allReg;
  assign sramDataOut_1 = selectedVec_0_1 ? toSRAM_1_rdata : 76'h0;
  wire        activated =
    mbist_all | mbist_req & (mbist_array == 8'hA4 | mbist_array == 8'hA5);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beReg = {_RANDOM[3'h0][31:11], _RANDOM[3'h1], _RANDOM[3'h2][22:0]};
        addrReg = _RANDOM[3'h2][30:23];
        dataInReg =
          {_RANDOM[3'h2][31], _RANDOM[3'h3], _RANDOM[3'h4], _RANDOM[3'h5][10:0]};
        renReg = _RANDOM[3'h5][11];
        addrRdReg = _RANDOM[3'h5][19:12];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 8'h0;
        reqReg = 1'h0;
