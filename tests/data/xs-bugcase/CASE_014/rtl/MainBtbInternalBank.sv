...
module MainBtbInternalBank(
  ...
  wire        _mbtb_sram_counter_align0_bank0_io_r_req_ready;
  wire        _mbtb_sram_counter_align0_bank0_io_w_req_ready;
  wire        _mbtb_sram_entry_align0_bank0_way3_io_r_req_ready;
  wire        _mbtb_sram_entry_align0_bank0_way3_io_w_req_ready;
  wire        _mbtb_sram_entry_align0_bank0_way2_io_r_req_ready;
  wire        _mbtb_sram_entry_align0_bank0_way2_io_w_req_ready;
  wire        _mbtb_sram_entry_align0_bank0_way1_io_r_req_ready;
  wire        _mbtb_sram_entry_align0_bank0_way1_io_w_req_ready;
  wire        _mbtb_sram_entry_align0_bank0_way0_io_r_req_ready;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      resetDone <=
        _mbtb_sram_entry_align0_bank0_way0_io_r_req_ready
        & _mbtb_sram_entry_align0_bank0_way1_io_r_req_ready
        & _mbtb_sram_entry_align0_bank0_way2_io_r_req_ready
        & _mbtb_sram_entry_align0_bank0_way3_io_r_req_ready
        & _mbtb_sram_counter_align0_bank0_io_r_req_ready | resetDone;
  ...
  SRAMTemplate_52 mbtb_sram_entry_align0_bank0_way0 (
    .clock                                     (clock),
    .reset                                     (reset),
    .io_r_req_ready
      (_mbtb_sram_entry_align0_bank0_way0_io_r_req_ready),
  ...
  SRAMTemplate_52 mbtb_sram_entry_align0_bank0_way1 (
    .clock                                     (clock),
    .reset                                     (reset),
    .io_r_req_ready
      (_mbtb_sram_entry_align0_bank0_way1_io_r_req_ready),
  ...
  SRAMTemplate_52 mbtb_sram_entry_align0_bank0_way2 (
    .clock                                     (clock),
    .reset                                     (reset),
    .io_r_req_ready
      (_mbtb_sram_entry_align0_bank0_way2_io_r_req_ready),
  ...
  SRAMTemplate_52 mbtb_sram_entry_align0_bank0_way3 (
    .clock                                     (clock),
    .reset                                     (reset),
    .io_r_req_ready
      (_mbtb_sram_entry_align0_bank0_way3_io_r_req_ready),
  ...
  SRAMTemplate_56 mbtb_sram_counter_align0_bank0 (
    .clock                          (clock),
    .reset                          (reset),
    .io_r_req_ready                 (_mbtb_sram_counter_align0_bank0_io_r_req_ready),
    .io_r_req_valid                 (io_read_req_valid),
    .io_r_req_bits_setIdx           (io_read_req_bits_setIdx),
